...
# Go fourth!
`;function Zt(){const[e,t]=c.useState(Mt),n=B();return r.jsx(b,{value:e,height:`calc(100vh - ${n.mixins.toolbar.minHeight}px)`,width:"100%",theme:n.palette.mode,extensions:[V()],onChange:i=>{t(i)}})}function _t(){const[e,t]=c.useState(""),n=fe("(prefers-color-scheme: dark)"),[i,o]=c.useState(m.RENDER),[s,a]=c.useState(""),[l,O]=c.useState(""),p=c.useRef(null),f=c.useMemo(()=>yt(a),[]),$=c.useMemo(()=>V(),[]),y=c.useMemo(()=>pe({palette:{mode:n?"dark":"light"}}),[n]),d=c.useCallback(P=>{t(P)},[]);function k(){switch(i){case m.TUTORIAL:return r.jsx(Zt,{});case m.RENDER:return r.jsx(Bt,{xmlString:s,htmlString:l,setHtmlString:O,nodeRef:p});case m.SWIML_XML:return r.jsx(Yt,{xmlContent:s})}}return r.jsxs(he,{theme:y,children:[r.jsx(we,{}),r.jsxs(w,{sx:{display:"flex",flexDirection:"column",height:"100vh"},children:[r.jsx(Qt,{swimdslProgramme:e,setSwimdslProgramme:t,swimlXml:s,htmlString:l,renderNode:p,children:r.jsx(Dt,{activePanelPage:i,setPanelPage:o})}),r.jsxs(w,{sx:{display:"flex",flex:1,overflow:"hidden"},children:[r.jsx(w,{sx:{width:i!==m.NONE?"50%":"100%"},borderRight:"1px solid",children:r.jsx(b,{value:e,style:{height:"100%"},width:"100%",height:"100%",theme:n?"dark":"light",extensions:[$,f],onChange:d})}),i!==m.NONE&&r.jsx(w,{sx:{width:"50%",overflow:"auto"},children:k()})]})]})]})}const R=document.getElementById("root");R!==null?G.createRoot(R).render(r.jsx(J.StrictMode,{children:r.jsx(_t,{})})):console.error("Root element does not exist!");
