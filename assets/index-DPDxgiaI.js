...
# Go fourth!
`;function Ft(){const[e,t]=c.useState($t),n=C();return r.jsx(x,{value:e,height:"100%",width:"100%",style:{height:"100%"},theme:n.palette.mode,extensions:[J()],onChange:s=>{t(s)}})}function Lt(){const[e,t]=c.useState(""),n=fe("(prefers-color-scheme: dark)"),[s,i]=c.useState(T.RENDER),[o,a]=c.useState(""),[l,d]=c.useState(""),f=c.useRef(null),m=c.useMemo(()=>Wt(a),[]),w=c.useMemo(()=>J(),[]),y=c.useMemo(()=>he({palette:{mode:n?"dark":"light"}}),[n]),O=c.useCallback(h=>{t(h)},[]);function g(h){switch(h){case T.TUTORIAL:return r.jsx(Ft,{});case T.RENDER:return r.jsx(Dt,{xmlString:o,htmlString:l,setHtmlString:d,nodeRef:f});case T.SWIML_XML:return r.jsx(Mt,{xmlContent:o})}}return r.jsxs(pe,{theme:y,children:[r.jsx(Se,{}),r.jsxs(S,{sx:{display:"flex",flexDirection:"column",height:"100vh"},children:[r.jsx(It,{swimdslProgramme:e,setSwimdslProgramme:t,swimlXml:o,htmlString:l,renderNode:f,children:r.jsx(Qt,{activePanelPage:s,setPanelPage:i})}),r.jsxs(S,{sx:{display:"flex",flex:1,overflow:"hidden",minHeight:0},children:[r.jsx(S,{sx:{width:s!==null?"50%":"100%",minWidth:0,minHeight:0},borderRight:"1px solid",children:r.jsx(x,{value:e,style:{height:"100%"},width:"100%",height:"100%",theme:n?"dark":"light",extensions:[w,m],onChange:O})}),s!==null&&r.jsx(S,{sx:{width:"50%",overflow:"hidden",minWidth:0,minHeight:0},children:g(s)})]})]})]})}const R=document.getElementById("root");R!==null?H.createRoot(R).render(r.jsx(G.StrictMode,{children:r.jsx(Lt,{})})):console.error("Root element does not exist!");
