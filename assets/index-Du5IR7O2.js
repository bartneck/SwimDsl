import{b as c,j as r,r as J}from"./react-CMFr3qCg.js";import{c as G}from"./react-dom-DX5UQ9U7.js";import{A as H,T as ee,P as T,a as te,B as N,M as ne,b as ie,L as oe,c as se,d as S,e as re,U as ae,S as le,C as g,f as ce,V as ue,I as me,H as de,g as Oe,u as B,h as fe,i as pe,j as he,k as we}from"./@mui-CmKafNEk.js";import{R as b}from"./@uiw-PGa3NKDv.js";import{V as Se,G as $e,H as $,L as ye,I as ke,J as Pe,K as ge,M as be,N as xe,O as ve,P as Ie,Q as Qe}from"./@codemirror-HnVgEYRi.js";import{L as Re,s as Te,a as u}from"./@lezer-CRier5-m.js";import{d as Ne}from"./fastest-levenshtein-ChoUA_u9.js";import{x as Be}from"./xmlbuilder2-DPvUJURa.js";import"./hoist-non-react-statics-VTAvmUN5.js";import"./scheduler-Bb8JjhAW.js";import"./@emotion-D3xeAZ7B.js";import"./@babel-BtohYyOd.js";import"./stylis-DDa9OTMq.js";import"./clsx-B-dksMZM.js";import"./react-transition-group-D_SqvwCt.js";import"./react-is-BPJnJB5S.js";import"./@popperjs-CMBiYTiD.js";import"./crelt-C8TCjufn.js";import"./@marijn-DXwl3gUT.js";import"./style-mod-Bs6eFhZE.js";import"./w3c-keyname-Vcq4gwWv.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))i(o);new MutationObserver(o=>{for(const s of o)if(s.type==="childList")for(const a of s.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&i(a)}).observe(document,{childList:!0,subtree:!0});function n(o){const s={};return o.integrity&&(s.integrity=o.integrity),o.referrerPolicy&&(s.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?s.credentials="include":o.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function i(o){if(o.ep)return;o.ep=!0;const s=n(o);fetch(o.href,s)}})();const C=["Freestyle","Free","Fr","Backstroke","Back","Bk","Breaststroke","Breast","Br","Butterfly","Fly","Fl","Choice","IndividualMedley","Medley","Im","ReverseIndividualMedley","ReverseMedley","ReverseIm","IndividualMedleyOverlap","MedleyOverlap","ImOverlap","IndividualMedleyOrder","MedleyOrder","ImOrder","ReverseIndividualMedleyOrder","ReverseMedleyOrder","ReverseImOrder","NumberOne","NumberTwo","NumberThree","NumberFour","NotFreestyle","NotFree","NotFr","NotBackstroke","NotBack","NotBk","NotBreastroke","NotBreast","NotBr","NotButterfly","NotFly","NotFl"],D=["Pull","Kick","Drill"],M=["Board","Pads","PullBuoy","Fins","Snorkel","Chute","StretchCord"],Y=["Title","Author","Description","Date","PoolLength","LengthUnit","Align","NumeralSystem","HideIntro","LayoutWidth"],Ce=["True","False"];function v(e){const t=new Set,n=$(e).cursor();do{if(n.name!=="PaceDefinition"||!n.firstChild())continue;const i=e.sliceDoc(n.from,n.to);t.add(i),n.parent()}while(n.next());return t}const Z=Pe.define({create:v,update(e,t){return t.docChanged?v(t.state):e}}),De=C.map(e=>({label:e,type:"constant",boost:e.length})),Me=M.map(e=>({label:e,type:"constant"})),Ye=D.map(e=>({label:e,type:"constant"})),Ze=Y.map(e=>({label:e,type:"constant"})),I={0:{priorNodeName:"Distance",nodeName:"Stroke",completions:De},1:{priorNodeName:"EquipmentSpecification",nodeName:"EquipmentName",completions:Me},2:{priorNodeName:"Pace",nodeName:"PaceAlias",completions:[]},3:{priorNodeName:"",nodeName:"StrokeType",completions:Ye},4:{priorNodeName:"",nodeName:"ConstantName",completions:Ze}};function _e(e){const t=$(e.state).resolveInner(e.pos,-1);I[2].completions=Array.from(e.state.field(Z)).map(n=>({label:n,type:"variable"}));for(const{priorNodeName:n,nodeName:i,completions:o}of Object.values(I)){if(t.name===n)return{from:e.pos,options:o,validFor:/^[A-Za-z]/};if(t.name===i)return{from:t.from,to:t.to,options:o,validFor:/^[A-Za-z]/}}return null}function _(e,t){let n=1/0,i=0;for(let o=0;o<t.length;o++){const s=Ne(e,t[o]);s<n&&(n=s,i=o)}return[t[i],n]}const F=2;function Fe(e,t){const[n,i]=_(e,Array.from(t)),o=[];return i<=F&&o.push({name:`Did you mean '${n}'?`,apply(s,a,l){s.dispatch({changes:{from:a,to:l,insert:n}})}}),o.push({name:"Define pace name",apply(s){s.dispatch({changes:{from:0,to:0,insert:`Pace ${e} = _%
...
# Go fourth!
`;function Zt(){const[e,t]=c.useState(Yt),n=B();return r.jsx(b,{value:e,height:`calc(100vh - ${n.mixins.toolbar.minHeight}px)`,width:"100%",theme:n.palette.mode,extensions:[V()],onChange:i=>{t(i)}})}function _t(){const[e,t]=c.useState(""),n=fe("(prefers-color-scheme: dark)"),[i,o]=c.useState(f.RENDER),[s,a]=c.useState(""),[l,d]=c.useState(""),p=c.useRef(null),O=c.useMemo(()=>yt(a),[]),y=c.useMemo(()=>V(),[]),k=c.useMemo(()=>pe({palette:{mode:n?"dark":"light"}}),[n]),m=c.useCallback(h=>{t(h)},[]);function P(h){switch(h){case f.TUTORIAL:return r.jsx(Zt,{});case f.RENDER:return r.jsx(Bt,{xmlString:s,htmlString:l,setHtmlString:d,nodeRef:p});case f.SWIML_XML:return r.jsx(Mt,{xmlContent:s})}}return r.jsxs(he,{theme:k,children:[r.jsx(we,{}),r.jsxs(S,{sx:{display:"flex",flexDirection:"column",height:"100vh"},children:[r.jsx(Qt,{swimdslProgramme:e,setSwimdslProgramme:t,swimlXml:s,htmlString:l,renderNode:p,children:r.jsx(Dt,{activePanelPage:i,setPanelPage:o})}),r.jsxs(S,{sx:{display:"flex",flex:1,overflow:"hidden"},children:[r.jsx(S,{sx:{width:i!==null?"50%":"100%"},borderRight:"1px solid",children:r.jsx(b,{value:e,style:{height:"100%"},width:"100%",height:"100%",theme:n?"dark":"light",extensions:[y,O],onChange:m})}),i!==null&&r.jsx(S,{sx:{width:"50%",overflow:"auto"},children:P(i)})]})]})]})}const R=document.getElementById("root");R!==null?G.createRoot(R).render(r.jsx(J.StrictMode,{children:r.jsx(_t,{})})):console.error("Root element does not exist!");
