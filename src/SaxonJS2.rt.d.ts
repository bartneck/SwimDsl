...
declare module "saxon-js" {
  ...
  export type XdmValue = XdmAtomicValue[];
  ...
  export function transform<Execution extends "sync" | "async">(
    options: TransformationOptions,
    execution: Execution = "sync",
  ): Execution extends "sync" ? TransformOutput : Promise<TransformOutput>;
